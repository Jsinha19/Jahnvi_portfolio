  ...
  return (
    ...
    >
      <div className="max-w-[620px]">
        <div className="mb-6 inline-flex items-center gap-3 text-xs uppercase tracking-[.22em] text-[#d77668]">
        ...
        <a
          ...
          href="mailto:hello@jahnvisinha.dev"
        >
